...
<section class="w-full h-screen justify-center flex items-center flex-col pt-16  max-[767px]: "> 
    <div class="main-login w-full h-full flex max-[767px]:flex-col max-[767px]:items-center ">
        ...
        <div class="right-login w-6/12  flex flex-col justify-center items-center bg-lime-300 max-[767px]:w-full max-[767px]:h-full">
            <div class="card-login w-4/12 h-2/4 flex flex-col justify-center items-center bg-white max-[767px]:w-10/12 max-[767px]:h-3/4 relative">
                <h1 class="text-5xl font-bold max-[767px]:text-3xl text-white drop-shadow-lg">ACESSAR</h1>
                <div class="login flex flex-col w-full h-48 justify-center items-center gap-2">
                    <div class="relative">
                        <input type="text" id="floating_outlined" type="text" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-200 appearance-none dark:text-black dark:border-gray-200 dark:focus:border-lime-300 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " require />
                    ...
                    <div class="relative">
                        <input type="text" id="floating_outlined" type="password" minlength="8" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-200 appearance-none dark:text-black dark:border-gray-200 dark:focus:border-lime-300 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " onclick="myFunction()" require/>
                ...
                <button class="btn-login w-4/12 h-10 bg-lime-300 text-white text-sm hover:bg-lime-500 transition-all duration-200 delay-200 font-bold max-[767px]:text-xl max-[767px]:w-4/12 max-[767px]:h-10" type="submit">ENTRAR</button>
                    <a href="" class="text-lime-300 font-medium hover:text-lime-500">cadastrar</a>
                </div>
                <span class="absolute w-10 h-10 bg-lime-300 bottom-0 right-0 rounded-tl-3xl "></span>
                <span class="absolute w-10 h-10 bg-lime-300 top-0 left-0 rounded-br-3xl"></span>
            </div>
